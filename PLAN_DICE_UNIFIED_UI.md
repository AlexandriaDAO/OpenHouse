...
if [ "$REPO_ROOT" = "/home/theseus/alexandria/openhouse" ]; then
    ...
    echo "Worktree: /home/theseus/alexandria/openhouse-dice-unified-ui"
    exit 1
fi
...
1. **Verify isolation** - You must be in worktree: `/home/theseus/alexandria/openhouse-dice-unified-ui`
...
5. **Create PR** (MANDATORY):
   ```bash
   git add .
   git commit -m "feat(dice): Redesign UI to unified single-panel layout
...
- Maintain all existing functionality and state management"
   ...
   git push -u origin feature/dice-unified-ui

   gh pr create --title "Feature: Unified Dice UI - Single Panel Design" --body "Implements PLAN_DICE_UNIFIED_UI.md
...
**Branch:** `feature/dice-unified-ui`
**Worktree:** `/home/theseus/alexandria/openhouse-dice-unified-ui`

---

# Implementation Plan: Unified Dice Game UI
