  ...
  useEffect(() => {
    const testConnection = async () => {
      ...
      try {
        ...
        console.error('Failed to connect to Plinko backend:', err);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <h1 className="text-4xl font-bold mb-2">Plinko Game</h1>
        <p className="text-gray-400">Drop the ball and watch it bounce to a multiplier!</p>
      </div>
        ...
        {!actorLoading && actor && !testingConnection && !error && greeting && (
          <div className="space-y-3">
            <div className="flex items-center gap-3 text-green-400">
              ...
              <span className="font-semibold">Connected to Plinko Backend</span>
            </div>
            ...
            <div className="text-sm text-gray-400">
              Canister ID: <span className="font-mono">weupr-2qaaa-aaaap-abl3q-cai</span>
            </div>
          </div>
        )}
      ...
      <div className="card max-w-2xl mx-auto">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-semibold">8, 12, or 16</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-400">Risk Levels:</span>
            <span className="font-semibold">Low, Medium, High</span>
          </div>
        </div>
      </div>
    </div>
